...
abstract class FestiPlugin
{
    ...
    public function __construct($pluginMainFile)
    {
        ...
        $this->_pluginPath = WP_CONTENT_DIR.'/plugins/'.$this->_pluginDirName;
        $this->_pluginUrl = WP_CONTENT_URL.'/plugins/'.$this->_pluginDirName;
    ...
    public function addActionListener($hook, $method)
    {
    ...
    public function onEnqueueCssFileAction($handle, $file = '', $deps = '')
    {
        $version = '';
        $media = '';
