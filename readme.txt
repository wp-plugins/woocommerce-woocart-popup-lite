...
Features for WooCart Popup Lite version:
...
Customization WooCart Popup Lite version
...
Filezilla will now set the file permissions for all the directories Once it is done, you can go back to your WooCart Popup Lite Settings and click on Refresh plagin button.
